	...
	public static void main(String[] args) throws IOException {
		...
		if (D<=0){
			...
			for (u=1;u<=D;u++){
				...
				//esta es la pega del de arriba pero invirtiendo los codigos
				
				for (i=9;i>=1;i--){ //i es igual al numero de filas, para que eso se cumpla i tiene que ser mayor o igual que 1, y luego ves restando de i en i, 1 en 1
					for (f=1;f<=10-i;f++){ //acuerdate que i en este caso son las filas, se que te poner nervioso pero el primer for sienpre son las filas ok?
						System.out.print(".");
					}
					for (f=10-i;f<=9;f++){ //f=10-i a f quitandole la fila
